...
urlpatterns = [
    path('passes/'                                    , SKUDViewSet           .as_view({'get'   :'repr_passes'     ,
                                                                                        'post'  :'add_pass'        }), name='passseseseseses'),
    
    path('passes/<int:id>/'                           , SKUDViewSet           .as_view({'get'   :'repr_pass'       })                        ),        
      
  # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      
    path('doors/'                                     , SKUDViewSet           .as_view({'get'   :'repr_doors'      ,
                                                                                        'post'  :'add_door'        })                        ),
    
    path('doors/<int:id>/'                            , SKUDViewSet           .as_view({'get'   :'repr_door'       })                        ),
    
    path('doors/<int:id>/passes/'                     , SKUDViewSet           .as_view({'get'   :'repr_passes_door',
                                                                                        'post'  :'add_door_pass'   ,
                                                                                        'delete':'remove_passes'   })                        ),
    
    path('doors/<int:door_id>/passes/<int:pass_id>/'  , SKUDViewSet           .as_view({'delete':'remove_pass'     })                        ),
